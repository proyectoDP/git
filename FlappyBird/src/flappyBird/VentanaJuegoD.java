...
public class VentanaJuegoD extends JFrame
	
{
	...
	public VentanaJuegoD() throws InterruptedException
	...
	
	{
		...
		posy = 200;
		pajaro.setBackground(Color.LIGHT_GRAY);
		contentPane.setLayout(null);
		contentPane.add(pajaro);
		pajaroHilo = new HiloPajaro (posx, posy, pajaro, suelo, controlador, 1);
		pajaroHilo.start();
		...
		techo.setBackground(Color.LIGHT_GRAY);
	    ...
	    
	    {
	    	...
	    	hiloEnerg = new HiloEnergia (posxe, valorAleatorio2, energ1, 1, 0, 0);
	    	hiloEnerg.start();
