...
public class VentanaJuegoM extends JFrame
	
{
	...
	public VentanaJuegoM() throws InterruptedException
	...
	
	{
		...
		posy = 200;
		pajaro.setBackground(Color.WHITE);
		...
		techo.setBackground(Color.WHITE);
